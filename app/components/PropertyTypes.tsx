...
export default function PropertyTypes() {
  ...
  const filterProperties = (type: string) => {
    ...
    if (info) {
      alert(
        `This would filter to show ${info.count} ${info.name} properties in the price range ${info.priceRange}.`
      );
    }
  };
  ...
  return (
    <section
      ...
      id={neighborhoodsSectionId}
      aria-labelledby={neighborhoodsHeadingId}
    >
      <div className="container">
        ...
        <div className="types-grid">
          <div className="property-type">
            ...
            <p>
              <strong>86 properties available</strong>
              <br />
            ...
            <button
              ...
              onClick={() => filterProperties('gated')}
            >
          ...
          <div className="property-type">
            ...
            <p>
              <strong>32 properties available</strong>
              <br />
          ...
          <div className="property-type">
            ...
            <p>
              <strong>41 properties available</strong>
              <br />
            ...
            <button
              type="button"
              className="view-property"
              onClick={() => filterProperties('sun-city')}
            >
          ...
          <div className="property-type">
            ...
            <p>
              <strong>67 properties available</strong>
              <br />
              Price range: $420,000 - $850,000
            </p>
            <ul>
            ...
            <button
              type="button"
              className="view-property"
              onClick={() => filterProperties('new-construction')}
            >
          ...
          <div className="property-type">
            ...
            <p>
              <strong>90 properties available</strong>
              <br />
            ...
            <button
              type="button"
              className="view-property"
              onClick={() => filterProperties('family')}
            >
