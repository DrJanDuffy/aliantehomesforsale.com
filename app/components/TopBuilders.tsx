...
function BuilderCard({ name, badge, stats, title, description, communities, incentives, primaryCTA, secondaryCTA, featured }: BuilderCardProps) {
  return (
    <article 
  ...
  const builders: BuilderCardProps[] = [
    {
      ...
      description: "America's #1 homebuilder includes smart home technology, Wi-Fi certified, and premium upgrades standard in every home.",
      communities: [
    ...
    },
    {
      ...
      description: "🏆 Dr. Jan Duffy is D.R. Horton's #1 Premiere Buyers Agent in North Las Vegas. Award-winning expert for Heartland at Tule Springs - the primary active builder community directly adjacent to Aliante with quick access to Aliante Resort and 215 Beltway.",
      communities: [
    ...
    },
    {
      ...
      description: 'Premium homebuilder known for high-end finishes, superior craftsmanship, and attention to detail. Every home features designer touches and luxury amenities.',
      communities: [
    ...
    },
    {
      ...
      description: "America's leading builder of active adult 55+ communities. Sun City Aliante features resort-style amenities, social activities, and maintenance-free living.",
      communities: [
    ...
    },
    {
      ...
      description: 'Fortune 500 builder delivering ultra-luxury homes since 1967. Renowned for superior design, premium materials, and unparalleled attention to detail. The benchmark for luxury new construction.',
      communities: [
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Choose from the nation's top-rated homebuilders
            </p>
          </div>
